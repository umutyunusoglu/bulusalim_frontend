...
flutterfire configure --> do NOT use the existing firebase.json file --> enable for ios 
and android (should already be selected but just in case) --> handles the project configs
